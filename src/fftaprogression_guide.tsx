...
const BLUE_MAGIC_REF: BlueRef[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "Mission", name: "Wind Sigil (#079)" },
      { type: "Mission", name: "Magewrym (#034)" },
      { type: "Mission", name: "The Worldwyrm (#088)" },
      { type: "Mission", name: "Pale Company (#011)" },
      { type: "Mission", name: "Wyrm's Awaken (#102)" },
      { type: "Mission", name: "A Dragon's Aid (#066)" },
      { type: "Mission", name: "Ruby Red (#031)" },
      { type: "Mission", name: "To Amberavle (#022)" },
    ],
...
const List = ({ l, a }: { l: string; a?: string[] }) =>
  ...
  const questItemRightRows = [
    ...
    { item: "Mythril", quest: ["Mythril Rush #103", "Seeking Silver #204"] },
    ...
    <div className="w-full max-w-6xl mx-auto p-4 bg-zinc-100 dark:bg-zinc-900 transition-colors">
      ...
      <div className="mt-3">
        <Panel
          ...
          subtitle='Take a moment to review the missables and warnings before proceeding to avoid later heartache! There are some items that can only be obtained via treasure hunting, the order I have provided for map locaiton placement ensures you get them all!'
