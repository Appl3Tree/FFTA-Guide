...
var ffta_map_gif_1 = require("./assets/ffta-map.gif");
var keyify = function (s) { return s.toLowerCase().replace(/[^a-z0-9]+/g, "-"); };
var pct = function (a, b) { return (b === 0 ? 0 : Math.round((a / b) * 100)); };
var toneDefaults = {
    neutral: {
...
function CollapsibleTwoTables(_a) {
    var title = _a.title, _b = _a.defaultOpen, defaultOpen = _b === void 0 ? false : _b, controlledOpen = _a.open, onToggle = _a.onToggle, _c = _a.className, className = _c === void 0 ? "" : _c, _d = _a.headerClassName, headerClassName = _d === void 0 ? "" : _d, _e = _a.bodyClassName, bodyClassName = _e === void 0 ? "" : _e, leftTitle = _a.leftTitle, leftRows = _a.leftRows, leftColumns = _a.leftColumns, rightTitle = _a.rightTitle, rightRows = _a.rightRows, rightColumns = _a.rightColumns, _f = _a.tone, tone = _f === void 0 ? "neutral" : _f, border = _a.border, text = _a.text, rowBg = _a.rowBg, headerBg = _a.headerBg, divider = _a.divider;
    var _g = (0, react_1.useState)(defaultOpen), uncontrolledOpen = _g[0], setUncontrolledOpen = _g[1];
    var isControlled = controlledOpen !== undefined;
    var open = isControlled ? controlledOpen : uncontrolledOpen;
    var contentId = (0, react_1.useId)();
    var toggle = function () { return (isControlled ? onToggle === null || onToggle === void 0 ? void 0 : onToggle(!open) : setUncontrolledOpen(!open)); };
    var d = toneDefaults[tone];
    var borderCls = border !== null && border !== void 0 ? border : d.border;
    var textCls = text !== null && text !== void 0 ? text : d.text;
    var rowBgCls = rowBg !== null && rowBg !== void 0 ? rowBg : d.rowBg;
    var headerBgCls = headerBg !== null && headerBg !== void 0 ? headerBg : d.headerBg;
    var dividerCls = divider !== null && divider !== void 0 ? divider : d.divider;
    return ((0, jsx_runtime_1.jsxs)("div", { className: "rounded-xl border ".concat(borderCls, " ").concat(className), children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", "aria-expanded": open, "aria-controls": contentId, onClick: toggle, className: "flex w-full items-center justify-between px-4 py-2 font-semibold text-center ".concat(textCls, " ").concat(headerBgCls, " ").concat(headerClassName), children: [(0, jsx_runtime_1.jsx)("span", { children: title }), (0, jsx_runtime_1.jsx)("svg", { className: "h-4 w-4 transition-transform ".concat(open ? "rotate-180" : ""), viewBox: "0 0 20 20", fill: "currentColor", children: (0, jsx_runtime_1.jsx)("path", { fillRule: "evenodd", d: "M5.23 7.21a.75.75 0 011.06.02L10 11.17l3.71-3.94a.75.75 0 111.08 1.04l-4.24 4.5a.75.75 0 01-1.08 0l-4.24-4.5a.75.75 0 01.02-1.06z", clipRule: "evenodd" }) })] }), open && ((0, jsx_runtime_1.jsx)("div", { id: contentId, className: "p-4 ".concat(bodyClassName), children: (0, jsx_runtime_1.jsxs)("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2", children: [(0, jsx_runtime_1.jsx)(TableSection, { title: leftTitle, rows: leftRows, columns: leftColumns, borderCls: borderCls, textCls: textCls, rowBgCls: rowBgCls, headerBgCls: headerBgCls, dividerCls: dividerCls }), (0, jsx_runtime_1.jsx)(TableSection, { title: rightTitle, rows: rightRows, columns: rightColumns, borderCls: borderCls, textCls: textCls, rowBgCls: rowBgCls, headerBgCls: headerBgCls, dividerCls: dividerCls })] }) }))] }));
}
function TableSection(_a) {
    var title = _a.title, rows = _a.rows, columns = _a.columns, borderCls = _a.borderCls, textCls = _a.textCls, rowBgCls = _a.rowBgCls, headerBgCls = _a.headerBgCls, dividerCls = _a.dividerCls;
    return ((0, jsx_runtime_1.jsxs)("section", { className: "overflow-x-auto rounded-lg border ".concat(borderCls), children: [(0, jsx_runtime_1.jsx)("header", { className: "px-3 py-2 text-sm font-semibold text-center ".concat(textCls, " ").concat(headerBgCls), children: title }), (0, jsx_runtime_1.jsxs)("table", { className: "min-w-full table-fixed", children: [(0, jsx_runtime_1.jsx)("thead", { className: "".concat(headerBgCls), children: (0, jsx_runtime_1.jsx)("tr", { children: columns.map(function (c) {
                                var _a;
                                return ((0, jsx_runtime_1.jsx)("th", { className: "px-3 py-2 text-left text-sm font-semibold ".concat(textCls, " ").concat((_a = c.className) !== null && _a !== void 0 ? _a : ""), scope: "col", children: c.header }, String(c.key)));
                            }) }) }), (0, jsx_runtime_1.jsx)("tbody", { className: "bg-transparent ".concat(dividerCls), children: rows.length === 0 ? ((0, jsx_runtime_1.jsx)("tr", { children: (0, jsx_runtime_1.jsx)("td", { className: "px-3 py-3 text-sm ".concat(textCls, "/70"), colSpan: columns.length, children: "No entries." }) })) : (rows.map(function (row, rowIdx) {
                            var _a;
                            return ((0, jsx_runtime_1.jsx)("tr", { className: "".concat(textCls), children: columns.map(function (c) {
                                    var _a;
                                    return ((0, jsx_runtime_1.jsx)("td", { className: "px-3 py-2 align-top whitespace-normal break-words min-w-0 ".concat(rowBgCls), children: c.cell ? c.cell(row[c.key], row, rowIdx) : String((_a = row[c.key]) !== null && _a !== void 0 ? _a : "") }, String(c.key)));
                                }) }, (_a = row.id) !== null && _a !== void 0 ? _a : rowIdx));
                        })) })] })] }));
}
// Affection data
var leftRows = [
...
var Tag = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("span", { className: "text-xs px-2 py-1 rounded inline-flex items-center gap-1 ring-1 ring-zinc-950/10 dark:ring-white/10 ".concat(map[color]), children: children }));
};
var ProgressBar = function (_a) {
    var done = _a.done, total = _a.total, label = _a.label, color = _a.color;
    var percent = pct(done, total);
    var palette = {
        blue: "bg-blue-500",
        green: "bg-green-500",
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "text-xs", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex justify-between", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-zinc-700 dark:text-zinc-300", children: label }), (0, jsx_runtime_1.jsxs)("span", { className: "text-zinc-600 dark:text-zinc-400", children: [done, "/", total, " (", percent, "%)"] })] }), (0, jsx_runtime_1.jsx)("div", { className: "h-2 bg-zinc-200 dark:bg-zinc-700 rounded", children: (0, jsx_runtime_1.jsx)("div", { className: "h-2 ".concat(palette[color], " rounded"), style: { width: "".concat(percent, "%") } }) })] }));
};
var Panel = function (_a) {
    var title = _a.title, border = _a.border, buttonColor = _a.buttonColor, children = _a.children, right = _a.right, _b = _a.tone, tone = _b === void 0 ? "neutral" : _b;
    var bgMap = {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "rounded-2xl p-3 ring-1 ring-zinc-950/10 dark:ring-white/10 ".concat(border, " ").concat(bgMap[tone], " transition-colors"), children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between", children: [(0, jsx_runtime_1.jsx)("h4", { className: "font-bold text-zinc-900 dark:text-zinc-100", children: title }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2", children: [right, (0, jsx_runtime_1.jsx)("button", { className: "".concat(buttonColor, " text-white text-sm px-3 py-1 rounded"), onClick: function () { return setOpen(function (o) { return !o; }); }, children: open ? "Hide" : "Show" })] })] }), open && (0, jsx_runtime_1.jsx)("div", { className: "mt-3", children: children })] }));
};
var FFTAProgressionGuide = function () {
    var _a = (0, react_1.useState)({}), expanded = _a[0], setExpanded = _a[1];
    var _b = (0, react_1.useState)({}), checked = _b[0], setChecked = _b[1];
    var toggle = function (k) { return setExpanded(function (p) {
        var _a;
        return (__assign(__assign({}, p), (_a = {}, _a[k] = !p[k], _a)));
    }); };
    var setCheck = function (k, v) {
        return setChecked(function (p) {
            var _a;
            return (__assign(__assign({}, p), (_a = {}, _a[k] = v !== null && v !== void 0 ? v : !p[k], _a)));
        });
    };
    var blueTotal = BLUE_MAGIC_REF.length;
    var blueDone = (0, react_1.useMemo)(function () {
        return BLUE_MAGIC_REF.reduce(function (n, b) { return n + (checked[keyify("blue:".concat(b.name))] ? 1 : 0); }, 0);
    }, [checked]);
    var capTotal = CAPTURE_REF.length;
    var capDone = (0, react_1.useMemo)(function () {
        return CAPTURE_REF.reduce(function (n, c) { return n + (checked[keyify("cap:".concat(c.monster))] ? 1 : 0); }, 0);
    }, [checked]);
    var missTotal = GLOBAL_MISSABLES.length;
    var missDone = (0, react_1.useMemo)(function () {
        return GLOBAL_MISSABLES.reduce(function (n, m) { return n + (checked[keyify("miss-global:".concat(m.id))] ? 1 : 0); }, 0);
    }, [checked]);
    var missionMap = (0, react_1.useMemo)(function () {
        var m = new Map();
        for (var _i = 0, MISSION_REF_1 = MISSION_REF; _i < MISSION_REF_1.length; _i++) {
            var q = MISSION_REF_1[_i];
            m.set(q.number, q);
        }
        return m;
    }, []);
    var questTotal = MISSION_REF.slice(2).length;
    var questKey = function (num) { return keyify("quest-global:".concat(num)); };
    var questDone = (0, react_1.useMemo)(function () {
        return MISSION_REF.reduce(function (n, q) { return n + (checked[questKey(q.number)] ? 1 : 0); }, 0);
    }, [checked]);
    var blocks = [
        {
            key: "tutorial",
    ...
    var MapPanel = function (_a) {
        var placements = _a.placements;
        return ((0, jsx_runtime_1.jsx)(Panel, { title: "World Map Placements", border: "border-purple-600", buttonColor: "bg-purple-600", tone: "purple", right: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), children: (0, jsx_runtime_1.jsxs)("div", { className: "space-y-3", children: [(0, jsx_runtime_1.jsx)("img", { src: ffta_map_gif_1.default, alt: "FFTA World Map", className: "w-full rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10" }), (0, jsx_runtime_1.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2 text-sm", children: placements.map(function (loc) {
                            var m = MAP_PLACEMENTS[loc];
                            if (!m)
                                return null;
                            return ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-start gap-2 bg-purple-50 dark:bg-purple-900/10 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: [(0, jsx_runtime_1.jsxs)("span", { className: "font-mono font-bold text-purple-700 dark:text-purple-300 min-w-[2rem]", children: [m.number, "."] }), (0, jsx_runtime_1.jsx)("div", { className: "flex-1", children: (0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-zinc-900 dark:text-zinc-100", children: m.title }) })] }, loc));
                        }) })] }) }));
    };
    var RefList = function (_a) {
        var type = _a.type, names = _a.names;
        var tagColor = type === "blue"
        ...
        return ((0, jsx_runtime_1.jsx)("ul", { className: "space-y-2", children: names.map(function (n) {
                // ----- BLUE -----
                if (type === "blue" && typeof n === "string") {
                    var id_1 = keyify("blue:".concat(n));
                    var isChecked = !!checked[id_1];
                    var b = BLUE_MAGIC_REF.find(function (x) { return x.name === n; });
                    if (!b)
                        return null;
                    return ((0, jsx_runtime_1.jsx)("li", { className: "whitespace-pre-line bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: (0, jsx_runtime_1.jsxs)("label", { className: "flex items-start gap-2", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "mt-1 accent-blue-600 dark:accent-blue-400", checked: isChecked, onChange: function () { return setCheck(id_1); } }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { className: "font-semibold ".concat(tagColor), children: [b.name, " ", (0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-zinc-500 dark:text-zinc-400", children: ["MP ", b.mp] })] }), b.desc && ((0, jsx_runtime_1.jsx)("div", { className: "text-sm text-zinc-800 dark:text-zinc-200", children: b.desc })), (0, jsx_runtime_1.jsxs)("div", { className: "text-xs mt-1 text-zinc-700 dark:text-zinc-300", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-zinc-900 dark:text-zinc-100", children: "From:" }), " ", b.from.join(", ")] }), b.sources.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { className: "mt-1 space-y-1", children: [b.sources.filter(function (s) { return s.type === "Clan"; }).length > 0 && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-zinc-900 dark:text-zinc-100", children: "Clans:" }), " ", b.sources
                                                                    .filter(function (s) { return s.type === "Clan"; })
                                                                    .map(function (s) { return s.name; })
                                                                    .join(", ")] })), b.sources.filter(function (s) { return s.type === "Mission"; }).length > 0 && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-zinc-900 dark:text-zinc-100", children: "Missions:" }), " ", b.sources
                                                                    .filter(function (s) { return s.type === "Mission"; })
                                                                    .map(function (s) { return s.name; })
                                                                    .join(", ")] })), b.sources.filter(function (s) { return s.type === "Turf"; }).length > 0 && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-zinc-900 dark:text-zinc-100", children: "Turf Defense:" }), " ", b.sources
                                                                    .filter(function (s) { return s.type === "Turf"; })
                                                                    .map(function (s) { return s.name; })
                                                                    .join(", ")] }))] })), b.notes && ((0, jsx_runtime_1.jsx)("div", { className: "mt-1 italic text-zinc-700 dark:text-zinc-300", children: b.notes }))] })] })] }) }, "blue-".concat(n)));
                }
                // ----- CAPTURE -----
                if (type === "cap" && typeof n === "string") {
                    var c = CAPTURE_REF.find(function (x) { return x.monster === n; });
                    if (!c)
                        return null;
                    var id_2 = keyify("cap:".concat(c.monster));
                    var isChecked = !!checked[id_2];
                    return ((0, jsx_runtime_1.jsx)("li", { className: "whitespace-pre-line bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: (0, jsx_runtime_1.jsxs)("label", { className: "flex items-start gap-2", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "mt-1 accent-green-600 dark:accent-green-400", checked: isChecked, onChange: function () { return setCheck(id_2); } }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { className: "font-semibold ".concat(tagColor), children: [c.monster, " ", (0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-zinc-500 dark:text-zinc-400", children: ["(", c.family, ")"] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "text-xs mt-1 space-y-1 text-zinc-900 dark:text-zinc-100", children: [c.clans && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold", children: "Random Battles:" }), " ", (0, jsx_runtime_1.jsx)("ul", { className: "list-disc list-inside ml-4", children: c.clans.map(function (m, i) { return (0, jsx_runtime_1.jsx)("li", { children: m }, i); }) })] })), c.missions && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold", children: "Missions:" }), " ", (0, jsx_runtime_1.jsx)("ul", { className: "list-disc list-inside ml-4", children: c.missions.map(function (m, i) { return (0, jsx_runtime_1.jsx)("li", { children: m }, i); }) })] })), c.areas && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold", children: "Turf Defense:" }), " ", (0, jsx_runtime_1.jsx)("ul", { className: "list-disc list-inside ml-4", children: c.areas.map(function (m, i) { return (0, jsx_runtime_1.jsx)("li", { children: m }, i); }) })] })), c.enjoys && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "font-semibold", children: "Enjoys:" }), (0, jsx_runtime_1.jsx)("ul", { className: "list-disc list-inside ml-4", children: c.enjoys.map(function (e, i) { return ((0, jsx_runtime_1.jsxs)("li", { children: [e.item, " ", (0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-gray-400", children: ["(Affection gained: ", e.aff, ")"] })] }, i)); }) })] })), c.spits && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "font-semibold", children: "Spits back:" }), (0, jsx_runtime_1.jsx)("ul", { className: "list-disc list-inside ml-4", children: c.spits.map(function (e, i) { return ((0, jsx_runtime_1.jsxs)("li", { children: [e.item, " ", (0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-gray-400", children: ["(Affection gained: ", e.aff, ")"] })] }, i)); }) })] }))] }), c.notes && ((0, jsx_runtime_1.jsx)("div", { className: "text-xs mt-1 italic text-zinc-700 dark:text-zinc-300", children: c.notes }))] })] }) }, "cap-".concat(n)));
                }
                // ----- MISSION (NEW) -----
                if (type === "quest" && typeof n === "number") {
                    var q = MISSION_REF.find(function (q) { return q.number === n; });
                    if (!q)
                        return null;
                    if (n === 0 || n === -1)
                        return null; // skip isekai and tutorial
                    var id_3 = questKey(n);
                    var isChecked = !!checked[id_3];
                    return ((0, jsx_runtime_1.jsx)("li", { className: "whitespace-pre-line bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: (0, jsx_runtime_1.jsxs)("label", { className: "flex items-start gap-2", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "mt-1 accent-purple-600 dark:accent-purple-400", checked: isChecked, onChange: function () { return setCheck(id_3); } }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { className: "font-semibold ".concat(tagColor), children: ["#", String(q.number).padStart(3, "0"), " \u2014 ", q.name] }), !isChecked && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [q.location && ((0, jsx_runtime_1.jsxs)("div", { className: "text-xs text-zinc-500 dark:text-zinc-400 mt-1", children: ["(", q.location, ")"] })), q.description && ((0, jsx_runtime_1.jsx)("div", { className: "text-sm text-zinc-800 dark:text-zinc-200 mt-1", children: q.description })), (0, jsx_runtime_1.jsxs)("div", { className: "text-xs mt-1 space-y-1 text-zinc-900 dark:text-zinc-100", children: [(0, jsx_runtime_1.jsx)(KV, { l: "Type", v: q.type }), (0, jsx_runtime_1.jsx)(KV, { l: "Difficulty", v: q.difficulty }), (0, jsx_runtime_1.jsx)(KV, { l: "Cost", v: q.cost }), (0, jsx_runtime_1.jsx)(KV, { l: "Location", v: q.location }), (0, jsx_runtime_1.jsx)(List, { l: "Prerequisites", a: q.prerequisites }), (0, jsx_runtime_1.jsx)(List, { l: "Rewards", a: q.reward }), (0, jsx_runtime_1.jsx)(List, { l: "Enemies", a: q.enemies })] })] }))] })] }) }, "mission-".concat(n)));
                }
                return null;
            }) }));
    };
    var KV = function (_a) {
        var l = _a.l, v = _a.v;
        return v ? (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("b", { children: [l, ":"] }), " ", v] }) : null;
    };
    var List = function (_a) {
        var l = _a.l, a = _a.a;
        return a && a.length ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { className: "font-semibold", children: [l, ":"] }), (0, jsx_runtime_1.jsx)("ul", { className: "list-disc list-inside", children: a.map(function (s, i) { return (0, jsx_runtime_1.jsx)("li", { children: s }, i); }) })] })) : null;
    };
    return ((0, jsx_runtime_1.jsxs)("div", { className: "w-full max-w-6xl mx-auto p-4 bg-zinc-100 dark:bg-zinc-900 transition-colors", children: [(0, jsx_runtime_1.jsxs)("div", { className: "bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6 rounded-t-2xl ring-1 ring-zinc-950/10 dark:ring-white/10 shadow-sm", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-3xl font-bold mb-1", children: "FFTA Story Progression Guide" }), (0, jsx_runtime_1.jsx)("p", { className: "text-sm opacity-90", children: "Story \u2022 Between-Story Missions \u2022 Blue Magic \u2022 Captures \u2022 Missables \u2022 Map Placements \u2022 Recruits" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-3 grid grid-cols-1 gap-3", children: [(0, jsx_runtime_1.jsx)(Panel, { title: "Blue Magic Reference", border: "border-blue-600", buttonColor: "bg-blue-600", tone: "blue", right: (0, jsx_runtime_1.jsx)("div", { className: "min-w-[200px]", children: (0, jsx_runtime_1.jsx)(ProgressBar, { label: "Blue Magic", done: blueDone, total: blueTotal, color: "blue" }) }), children: (0, jsx_runtime_1.jsx)(RefList, { type: "blue", names: BLUE_MAGIC_REF.map(function (b) { return b.name; }) }) }), (0, jsx_runtime_1.jsxs)(Panel, { title: "Capturable Monsters Reference", border: "border-green-600", buttonColor: "bg-green-600", tone: "green", right: (0, jsx_runtime_1.jsx)("div", { className: "min-w-[200px]", children: (0, jsx_runtime_1.jsx)(ProgressBar, { label: "Captures", done: capDone, total: capTotal, color: "green" }) }), children: [(0, jsx_runtime_1.jsx)(CollapsibleTwoTables, { title: "Affection & Items Cheatsheet", defaultOpen: true, tone: "neutral" // gives sensible defaults
                                ...
                                ] }), (0, jsx_runtime_1.jsx)(RefList, { type: "cap", names: CAPTURE_REF.map(function (c) { return c.monster; }) })] }), (0, jsx_runtime_1.jsx)(Panel, { title: "Mission Reference", border: "border-amber-600", buttonColor: "bg-amber-600", tone: "amber", right: (0, jsx_runtime_1.jsx)("div", { className: "min-w-[200px]", children: (0, jsx_runtime_1.jsx)(ProgressBar, { label: "Missions", done: questDone, total: questTotal, color: "amber" }) }), children: (0, jsx_runtime_1.jsx)(RefList, { type: "quest", names: MISSION_REF.map(function (q) { return q.number; }) }) })] }), (0, jsx_runtime_1.jsx)("div", { className: "mt-3", children: (0, jsx_runtime_1.jsx)(Panel, { title: "Missables & Warnings (Global)", border: "border-red-600", buttonColor: "bg-red-600", tone: "red", right: (0, jsx_runtime_1.jsx)("div", { className: "min-w-[200px]", children: (0, jsx_runtime_1.jsx)(ProgressBar, { label: "Missables", done: missDone, total: missTotal, color: "red" }) }), children: (0, jsx_runtime_1.jsx)("ul", { className: "space-y-2 text-sm", children: GLOBAL_MISSABLES.map(function (m) {
                            var id = keyify("miss-global:".concat(m.id));
                            return ((0, jsx_runtime_1.jsxs)("li", { className: "flex items-start gap-2 bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "mt-0.5 accent-red-600 dark:accent-red-400", checked: !!checked[id], onChange: function () { return setCheck(id); } }), (0, jsx_runtime_1.jsx)("span", { className: "text-zinc-800 dark:text-zinc-200", children: m.text })] }, m.id));
                        }) }) }) }), (0, jsx_runtime_1.jsx)("div", { className: "mt-4 space-y-2", children: blocks.map(function (b) {
                    var isOpen = !!expanded[b.key];
                    var blueNames = b.blue || [];
                    var capNames = b.caps || [];
                    var side = b.sidequests || [];
                    var recs = b.recruits || [];
                    var miss = b.missables || [];
                    var quest = b.sidequests || [];
                    var blueDoneLocal = blueNames.reduce(function (n, b) { return n + (checked[keyify("blue:".concat(b))] ? 1 : 0); }, 0);
                    var capDoneLocal = capNames.reduce(function (n, c) { return n + (checked[keyify("cap:".concat(c))] ? 1 : 0); }, 0);
                    var recsDoneLocal = recs.reduce(function (n, r) { return n + (checked[keyify("recruit:".concat(r))] ? 1 : 0); }, 0);
                    var missDoneLocal = miss.reduce(function (n, m) { return n + (checked[keyify("miss-global:".concat(m))] ? 1 : 0); }, 0);
                    var questDoneLocal = quest.reduce(function (n, q) { return n + (checked[keyify("quest-global:".concat(q))] ? 1 : 0); }, 0);
                    return ((0, jsx_runtime_1.jsxs)("div", { className: "rounded-2xl overflow-hidden ring-1 ring-zinc-950/10 dark:ring-white/10 transition-colors ".concat(b.kind === "story"
                            ? "bg-amber-50 dark:bg-amber-900/10"
                            : "bg-white dark:bg-zinc-800"), children: [(0, jsx_runtime_1.jsxs)("div", { className: "p-4 flex items-center justify-between cursor-pointer ".concat(b.kind === "story"
                                    ? "hover:bg-amber-100 dark:hover:bg-amber-900/20"
                                    : "hover:bg-zinc-50 dark:hover:bg-zinc-800/70"), onClick: function () { return toggle(b.key); }, children: [(0, jsx_runtime_1.jsx)("div", { className: "space-y-1", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2 flex-wrap", children: [(0, jsx_runtime_1.jsx)("span", { className: "font-bold text-lg text-zinc-900 dark:text-zinc-100", children: b.title }), b.subtitle && ((0, jsx_runtime_1.jsxs)("span", { className: "text-sm text-zinc-600 dark:text-zinc-400", children: ["(", b.subtitle, ")"] })), b.placements && b.placements.length > 0 && ((0, jsx_runtime_1.jsxs)(Tag, { color: "purple", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.MapPin, { className: "w-3 h-3" }), "Place #", b.placements
                                                            .map(function (l) { var _a; return (_a = MAP_PLACEMENTS[l]) === null || _a === void 0 ? void 0 : _a.number; })
                                                            .filter(Boolean)
                                                            .join(", ")] })), blueNames.length > 0 && ((0, jsx_runtime_1.jsxs)(Tag, { color: "blue", children: ["Blue Magic ", blueDoneLocal, "/", blueNames.length] })), capNames.length > 0 && ((0, jsx_runtime_1.jsxs)(Tag, { color: "green", children: ["Captures ", capDoneLocal, "/", capNames.length] })), b.kind === "between" && side.length > 0 && ((0, jsx_runtime_1.jsxs)(Tag, { color: "amber", children: ["Side ", questDoneLocal, "/", side.length] }))] }) }), isOpen ? ((0, jsx_runtime_1.jsx)(lucide_react_1.ChevronUp, { className: "text-zinc-500" })) : ((0, jsx_runtime_1.jsx)(lucide_react_1.ChevronDown, { className: "text-zinc-500" }))] }), isOpen && ((0, jsx_runtime_1.jsxs)("div", { className: "p-4 space-y-4 border-t border-zinc-200 dark:border-zinc-800", children: [b.kind === "story" && side.map(function (num) {
                                        var id = keyify("quest-global:".concat(num));
                                        var q = missionMap.get(num);
                                        return ((0, jsx_runtime_1.jsx)("li", { className: "flex items-start gap-2 bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: (0, jsx_runtime_1.jsx)("div", { className: "text-zinc-800 dark:text-zinc-200", children: q ? ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("div", { className: "italic", children: q.strategy &&
                                                            q.strategy.length ? ((0, jsx_runtime_1.jsx)("pre", { className: "whitespace-pre-wrap text-zinc-800 dark:text-zinc-200", children: q.strategy })) : ("None") }) })) : ((0, jsx_runtime_1.jsx)("div", { className: "font-semibold", children: "No strategy available." })) }) }, num));
                                    }), b.placements && b.placements.length > 0 && ((0, jsx_runtime_1.jsx)(MapPanel, { placements: b.placements })), blueNames.length > 0 && ((0, jsx_runtime_1.jsx)(Panel, { title: "Blue Magic Available", border: "border-blue-600", buttonColor: "bg-blue-600", tone: "blue", right: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), children: (0, jsx_runtime_1.jsx)(RefList, { type: "blue", names: blueNames }) })), capNames.length > 0 && ((0, jsx_runtime_1.jsx)(Panel, { title: "Capturable Monsters", border: "border-green-600", buttonColor: "bg-green-600", tone: "green", right: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), children: (0, jsx_runtime_1.jsx)(RefList, { type: "cap", names: capNames }) })), b.kind === "between" && side.length > 0 && ((0, jsx_runtime_1.jsx)(Panel, { title: "Side Missions Now Available", border: "border-amber-600", buttonColor: "bg-amber-600", tone: "amber", right: (0, jsx_runtime_1.jsx)("div", { className: "min-w-[180px]", children: (0, jsx_runtime_1.jsx)(ProgressBar, { label: "Side", done: questDoneLocal, total: side.length, color: "purple" }) }), children: (0, jsx_runtime_1.jsx)("ul", { className: "space-y-2 text-sm", children: side.map(function (num) {
                                                var id = keyify("quest-global:".concat(num));
                                                var q = missionMap.get(num);
                                                return ((0, jsx_runtime_1.jsxs)("li", { className: "flex items-start gap-2 bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "mt-0.5 accent-purple-600 dark:accent-purple-400", checked: !!checked[id], onChange: function () { return setCheck(id); } }), (0, jsx_runtime_1.jsx)("div", { className: "text-zinc-800 dark:text-zinc-200", children: q ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "font-semibold text-zinc-900 dark:text-zinc-100", children: ["#", String(q.number).padStart(3, "0"), " \u2014", " ", q.name] }), (0, jsx_runtime_1.jsxs)("div", { className: "text-xs text-zinc-600 dark:text-zinc-400", children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold", children: "Prerequisites:" }), " ", q.prerequisites &&
                                                                                q.prerequisites.length ? ((0, jsx_runtime_1.jsx)("ul", { className: "list-disc ml-5 mt-1", children: q.prerequisites.map(function (p, i) { return ((0, jsx_runtime_1.jsx)("li", { children: p }, i)); }) })) : ("None")] })] })) : ((0, jsx_runtime_1.jsxs)("div", { className: "font-semibold", children: ["#", String(num).padStart(3, "0"), " \u2014 Unknown quest"] })) })] }, num));
                                            }) }) })), recs.length > 0 && ((0, jsx_runtime_1.jsx)(Panel, { title: "Recruits / Unlocks", border: "border-purple-600", buttonColor: "bg-purple-600", right: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), children: (0, jsx_runtime_1.jsx)("ul", { className: "space-y-2 text-sm", children: recs.map(function (line) {
                                                var id = keyify("rec:".concat(b.key, ":").concat(line));
                                                return ((0, jsx_runtime_1.jsxs)("li", { className: "flex items-start gap-2 bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "mt-0.5 accent-purple-600 dark:accent-purple-400", checked: !!checked[id], onChange: function () { return setCheck(id); } }), (0, jsx_runtime_1.jsx)("span", { className: "text-zinc-800 dark:text-zinc-200", children: line })] }, id));
                                            }) }) })), miss.length > 0 && ((0, jsx_runtime_1.jsx)(Panel, { title: "Missables (Local)", border: "border-red-600", buttonColor: "bg-red-600", right: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), children: (0, jsx_runtime_1.jsx)("ul", { className: "space-y-2 text-sm", children: miss.map(function (line) {
                                                var id = keyify("miss:".concat(b.key, ":").concat(line));
                                                return ((0, jsx_runtime_1.jsxs)("li", { className: "flex items-start gap-2 bg-white dark:bg-zinc-800 p-2 rounded-xl ring-1 ring-zinc-950/10 dark:ring-white/10", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "mt-0.5 accent-red-600 dark:accent-red-400", checked: !!checked[id], onChange: function () { return setCheck(id); } }), (0, jsx_runtime_1.jsx)("span", { className: "text-zinc-800 dark:text-zinc-200", children: line })] }, id));
                                            }) }) }))] }))] }, b.key));
                }) }), (0, jsx_runtime_1.jsx)("div", { className: "bg-zinc-800/90 text-zinc-200 p-4 rounded-b-2xl text-center text-sm mt-4 ring-1 ring-white/10", children: (0, jsx_runtime_1.jsx)("p", { children: "Check off tasks as you complete them. Show/Hide panels keep each section compact." }) })] }));
};
exports.default = FFTAProgressionGuide;
